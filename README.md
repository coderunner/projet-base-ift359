...
| :--- | :--- |
| `npm run dev` | Exécute et surveille le code TypeScript (`src/index.ts`) avec rechargement automatique à chaque sauvegarde. |
| `npm run build` | Vérifie les types et compile le projet TypeScript vers JavaScript dans le dossier `dist/`. |
| `npm start` | Exécute le code JavaScript compilé (`dist/index.js`) avec Node.js. |
